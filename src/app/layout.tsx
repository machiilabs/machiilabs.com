...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Skagway 1.3 is out: Storyboard view, Hide Inspector, and Reconnect for missing files. Free Mac video organizer for the files already on your drives.",
  ...
  twitter: {
    ...
    title: "Mach II Labs — Skagway 1.3",
    description:
      "Skagway 1.3 is out: Storyboard view, Hide Inspector, and Reconnect for missing files.",
