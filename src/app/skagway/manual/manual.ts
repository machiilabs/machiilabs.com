    ...
    sections: [
      {
        ...
        screenshots: [
          {
            filename: "collection-set.png",
            alt: "Skagway Grid with checkmarked collected cards and the orange batch Inspector header",
            hint: "Batch inspect: two or more checkmarked cards, collection pill, Inspector orange “N Videos Selected” bar.",
          },
          {
            filename: "collection-set-single.png",
            alt: "Skagway Grid with a collected clip focused and the light blue single-clip Inspector header",
